...
namespace Projekt_atrakcje.Migrations
{
    ...
    [Migration("20240407110229_Dodanie_relacji_cityUser")]
    partial class Dodanie_relacji_cityUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projekt_atrakcje.Models.Grade", b =>
                {
            ...
            modelBuilder.Entity("CityUser", b =>
                {
                    b.HasOne("Projekt_atrakcje.Models.City", null)
                        .WithMany()
                        .HasForeignKey("CitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Projekt_atrakcje.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Projekt_atrakcje.Models.Grade", b =>
                {
                    b.HasOne("Projekt_atrakcje.Models.Attraction", "Attraction")
                        .WithMany("Grades")
                        .HasForeignKey("AttractionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Projekt_atrakcje.Models.User", "User")
                        .WithMany("Grades")
